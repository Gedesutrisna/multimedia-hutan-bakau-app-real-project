...
@section('container')
    ...
    <!-- Main content -->
        ...
        <div class="content-main p-[32px] lg:ms-10 xl:ms-4 2xl:ms-0 bg-body {{ $categories->count() < 2 ? 'h-[100vh]' : '' }}">
            <div class="sm:flex sm:justify-between block items-end">
                ...
                <div class="">
                    <a href="/dashboard/categories/create">
                        <button class="mt-[14px] sm:mt-0 py-[14px] px-[16px] bg-[#428574] rounded-[4px] gap-2 flex items-center text-white font-Urbanist text-[14px] font-medium"><img src="/asset/add-icon.svg" alt="" />Tambah Kategori</button>
                    </a>
                </div>
            </div>
                                            ...
                                            <div class="">
                                                ...
                                                <form method="POST" action="/dashboard/categories/{{ $category->slug }}">
                                                    ...
                                                    <div class="flex items-center justify-between w-full mt-8 gap-2">
                                                        <button class="px-[20px] py-[16px] bg-[#428574] rounded-[6px] font-Urbanist font-medium text-[15px] text-white w-full">Hapus Kategori</button>
