            ...
            <div class="sm:flex sm:justify-between block items-end">
                ...
                <div class="">
                    <a href="/dashboard/quizzes/create">
                        <button class="mt-[14px] sm:mt-0 py-[14px] px-[16px] bg-[#428574] rounded-[4px] gap-2 flex items-center text-white font-Urbanist text-[14px] font-medium"><img src="/asset/add-icon.svg" alt="" />Tambah Kuis</button>
                    </a>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center flex gap-1">
                                    ...
                                    <a href="/dashboard/quizzes/{{ $quiz->slug }}/edit">
                                        <button
                                    ...
                                    <button class="py-[6px] px-[3px] bg-[#F1E2E6] rounded-[5px] w-[32px] h-[32px] flex justify-center items-center" onclick="my_modal_4{{ $quiz->id }}.showModal()">	
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <path
                                        ...
                                        <dialog id="my_modal_4{{ $quiz->id }}" class="modal">
