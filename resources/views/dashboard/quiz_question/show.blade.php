                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if (empty($answer->answer_image) && !empty($answer->answer_text))
                                    <td>{{ Str::limit($answer->answer_text, 130) }}</td>
                                @elseif (!empty($answer->answer_image) && empty($answer->answer_text))
                                    <td><img src="{{ asset('images/'.$answer->answer_image) }}" alt="" style="width: 40px"></td>
                                @elseif (empty($answer->answer_image) && empty($answer->answer_text))
                                    <td>-</td>
                                @endif  
                                                ...
                                                <div class="">
                                                    ...
                                                    <p class="pt-4 font-Urbanist font-medium text-[15px] text-[#4D5369]">Konfirmasi Penghapusan Catatan Jawaban: Apakah Anda yakin ingin menghapus catatan jawaban ini? Tindakan ini tidak dapat dibatalkan, dan rekaman jawaban akan dihapus secara permanen dari sistem.
                                                        ...
                                                        <div class="flex items-center justify-between w-full mt-8 gap-2">
                                                            <button class="px-[20px] py-[16px] bg-[#428574] rounded-[6px] font-Urbanist font-medium text-[15px] text-white w-full">Hapus Jawaban</button>
