...
@section('container')
    ...
    <div class="content-main p-[32px]">
        <div class="flex gap-3">
            ...
            <p class="text-[#141414] text-[28px] font-Urbanist font-semibold">Edit User {{ $user->name }}</p>
        </div>
        ...
        <div class="flex items-center gap-2 mt-[26px]">
            <button type="submit" class="py-[14px] px-4 bg-[#6E62E5] text-white rounded-[8px]">Edit User</button>
